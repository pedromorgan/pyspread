...
class ContextMenu(_filledMenu, EventMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        [item, [self.CutMsg, _("Cu&t"), _("Cut cell to clipboard"),
                wx.ID_CUT]],
        [item, [self.CopyMsg, _("&Copy"), _("Copy input strings to clipboard"),
                wx.ID_COPY]],
        [item, [self.PasteMsg, _("&Paste"), _("Paste cells from clipboard"),
                wx.ID_PASTE]],
        ...
        [item, [self.DeleteColsMsg, _("Delete columns"), _("Delete columns")]],
        ]
