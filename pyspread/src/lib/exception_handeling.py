...
exception_handeling.py contains functions for handeling exceptions generated by user code

Provides
--------

* get_user_codeframe: Returns traceback that only includes the user's execute code frames
...
def get_user_codeframe(tb):
    ...
    (this is necessary because copying traceback objects is tricky and this is a good workaround)
    """
